...
int main(){
	...
	Szyfr_RSA szyf;
	key klucz = szyf.RSA();
	string s = "lubie kwiatki i nie tylko. lubie tez kropeczki i pszczolki i rozne inne rzeczy. lubie tez duzo rzeczy na ktpre lubie spedzac wiele czasu. bomba jest w szkole. lubie kwiatki STOP STOP dzien dobry jak sie pan ma? Bo ja Bardzo dobrze !@#$%^&()(*&^%$#@!!!!!!! ?? ? ? ? ? ?";// i odkrywać ich piękno w najdrobniejszych szczegółach. Czasami siadam w ogrodzie, obserwując, jak pszczółki tańczą wokół kwiatów, a kropeczki na biedronkach dodają uroku każdemu liściowi. Lubię zbierać muszki, każdy z nich jest jak małe dzieło sztuki, a ich różnorodność kolorów i kształtów fascynuje mnie niezmiennie.Czasem marzę o wyprawach do lasów czy na łąki, gdzie mogę spędzać godziny, poznając różne gatunki roślin i zwierząt. Lubię też robić zdjęcia, uwieczniając te ulotne chwile radości, które natura mi ofiarowuje. A wieczorem siadam z kubkiem ciepłej herbaty i podziwiam moje fotograficzne dzieła, myśląc o wszystkich przygodach, które jeszcze przede mną.Tak wiele rzeczy sprawia mi radość! Czy to śpiew ptaków o poranku, czy delikatny zapach bzu w powietrzu. Każdy dzień to nowa okazja, by odkrywać, zachwycać się i w pełni cieszyć się pięknem otaczającego mnie świata. Lubię życie, bo jest pełne niespodzianek i chwil, które warto celebrować.";	string r;
